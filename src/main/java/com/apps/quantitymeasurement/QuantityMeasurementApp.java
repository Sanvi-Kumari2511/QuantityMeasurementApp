...
public class QuantityMeasurementApp {
	...
	public static void main(String[] args) {
		System.out.println(
				"1 ft == 12 in ? " + demonstrateLengthComparison(1.0, LengthUnit.FEET, 12.0, LengthUnit.INCHES));

		System.out.println(
				"convert(3 yards -> feet) = " + demonstrateLengthConversion(3.0, LengthUnit.YARDS, LengthUnit.FEET));

		Length sum = demonstrateLengthAddition(new Length(1.0, LengthUnit.FEET), new Length(12.0, LengthUnit.INCHES));
